[[Enumeration]]
	...
	```nmap
		 sudo nmap -T4 -A -p- $ip
		Starting Nmap 7.93 ( https://nmap.org ) at 2023-03-08 20:41 GMT
		...
		TCP/IP fingerprint:
		OS:SCAN(V=7.93%E=4%D=3/8%OT=135%CT=1%CU=37898%PV=Y%DS=2%DC=T%G=Y%TM=6408F34
		OS:0%P=x86_64-pc-linux-gnu)SEQ(SP=100%GCD=1%ISR=10D%TI=I%CI=I%II=I%SS=S%TS=
		...
		HOP RTT      ADDRESS
		1   16.21 ms 10.10.14.1
		2   16.69 ms 10.129.1.12
